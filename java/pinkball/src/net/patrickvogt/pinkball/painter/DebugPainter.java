...
public final class DebugPainter implements IPainter
{
    ...
    private static final int VECTOR_STRETCH = 50;
    private static final int VECTOR_ARRAY_HEAD_SIZE = 4;
    ...
    public final void paint(final Ball b)
    {
        ...
        final int cx = b.getCenter().getXAsInt();
        final int cy = b. getCenter().getYAsInt();
        final float dx = b.getSpeed().getDX()*VECTOR_STRETCH;
        final float dy = b.getSpeed().getDY()*VECTOR_STRETCH;
...
//        {
//            this._g.drawRect(xPoints[i], yPoints[i], 2, 2);
//        }
