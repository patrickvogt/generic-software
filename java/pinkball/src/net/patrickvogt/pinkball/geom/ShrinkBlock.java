...
/**
 * implementiert einen SpielStein, der die Kugeln bis zu einer bestimmten
 * Groesse schrumpfen laesst
 * 
 * @author Patrick Vogt
 * 
 */
...
public class ShrinkBlock extends GeometricObject
{
     ...
     * 
     * @param _myDimension
     *            die Dimension (Weite/Hoehe) des zu erzeugenden Objekts
     * 
     * @param _myColor
     *            die Farbe des zu erzeugenden Objekts
     * 
     */
    public ShrinkBlock(float __pos_x, float __pos_y, float __width,
    ...
    /**
     * reagiert auf eine Kollision zwischen <code>ShrinkingBlock</code> und
     * <code>Ball</code>
     * 
     * @param that
    ...
    public GeometricObject handleCollision(GeometricObject that)
    {
        ...
        // (Grau gilt im Spiel als neutrale Farbe und kann alle Kugeln
        // schrumpfen)
        if(this.getColor() == Color.GRAY || this.getColor() == that.getColor())
        {
            // ist der Durchmesser der Kugel groesser als die Haelfte des
            // ShrinkingBlocks?
